...
#' \code{\link[geneHapR:hap_result]{hap_result()}}.
#' @usage
#' get_hapNet(hapResult,
#'            accGroup = accGroup,
#'            groupName = groupName)
...
#'     pages = {419-420},
#' }
#' @param hapResult object of `hapSummary` class, generated by `hap_result()`
...
#' @seealso
#' \code{\link[geneHapR:hap_result]{hap_result()}} and
...
#' @title as.haplotype
#' @usage
#' as.haplotype(hapResult)
#' @description convert hapSummary into haplotype (pegas)
#' @note It's not advised for hapSummary with indels, due to indels will
