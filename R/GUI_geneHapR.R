#' @name GUI_geneHapR
#' @title the GUI interface of geneHapR
#' @import shiny
#' @importFrom shinyjs hidden hide show useShinyjs toggle
#' @importFrom utils choose.dir choose.files read.csv
#' @export
...
4.0 Basic steps:
4.0.1 Adjust image size (unit: pixel) and resolution
4.0.2 Adjust Optional Parameters
4.0.3 Click (Plot IMG)
...
<p>
4.0 \u57fa\u672c\u6b65\u9aa4\uff1a
4.0.1 \u8c03\u6574\u56fe\u50cf\u5927\u5c0f\uff08\u5355\u4f4d\uff1a\u50cf\u7d20\uff09\u3001\u56fe\u50cf\u5206\u8fa8\u7387\uff08resolution\uff09
4.0.2 \u8c03\u6574\u53ef\u9009\u53c2\u6570
4.0.3 \u70b9\u51fb\uff08Plot IMG\uff09
4.1 \u5355\u500d\u578b\u53d8\u5f02\u4fe1\u606f\u603b\u89c8\uff08Visualization->Haplotype Table\uff09
4.2 \u5355\u500d\u578b\u53d8\u5f02\u4f4d\u70b9\u5728\u57fa\u56e0\u4e0a\u7684\u4f4d\u7f6e\uff08Visualization->Display Variants on Gene Model\uff09
4.3 \u5355\u500d\u578b\u7f51\u7edc\uff08Visualization->HaploNet\uff09
4.4 \u4e3b\u8981\u5355\u500d\u578b\u5730\u7406\u5206\u5e03\uff08Visualization->Geo-distribution\uff09
4.5 \u8868\u578b\u6bd4\u8f83\uff08Visualization->Phenotype Comparison\uff09
4.6 LD\u70ed\u56fe\uff08Visualization->LD Heatmap\uff09
</p>"
...
server <- function(input, output, session) {
    ...
    observeEvent(input$chooseresultdir,{
        dir <- utils::choose.dir(default = getwd())
    ...
    observeEvent(input$plothaplonet,{
        ...
        message("ploting")
        if(any(input$plothapnet_legend_size, input$plothapnet_legend_color))
            legend <- c(input$plothapnet_x, input$plothapnet_y) else
                legend <- FALSE
...
ui <- function(...){
        ...
        tabPanelBody(
            ...
            fluidRow(
                ...
                column(width = 7,
                       ...
                       "</a>")),
                       column(width = 12, id = "help_ch",
                                     p(HTML(text = h_en))),
                       hidden(column(width = 12, id = "help_ch",
                                     p(HTML(text = h_ch))))
    ...
    haploNet <- tabPanel(
        ...
        fluidRow(column(width = 6,
                        numericInput("plothapnet_x", "x", value = -10)),
                 column(width = 6,
                        numericInput("plothapnet_y", "y", value = 10))),
        br(),
