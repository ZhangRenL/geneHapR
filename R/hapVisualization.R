...
#' as input directly.
#' However user can import hap result from file with `import_hap()`
#'
#' @usage
#' hap_summary(hap,
#'            hapPrefix = "H",
...
#' In this case, we can custom INFOs in hapSummarys with `addINFO()` or
#' `replaceINFO()`.
...
#' @import tidyr
#' @param gff gff
#' @param hapSummary ouput of hap_summary(), a data.frame consistant
