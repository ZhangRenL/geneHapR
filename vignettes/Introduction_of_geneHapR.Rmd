...
`geneHapR` could be installed from **gitee**.
...
AccINFO <- import_pheno("accession_group_file_path.txt")
```
...
```{r geo distribution, fig.height=4, fig.width=6, message=FALSE, warning=FALSE, paged.print=FALSE}
# library(mapdata)
# library(maptools)
